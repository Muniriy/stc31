...
public class MathBox extends ObjectBox {
     ...
     */
    public MathBox(List<Number> numbers) throws InputMismatchException {
        super(Collections.singleton(numbers));
        for (Object n : numbers) {
            if (!(n.getClass().getSuperclass().equals(Number.class))) {
                throw new InputMismatchException(n.getClass().getSuperclass().getSimpleName());
            }
        }
    ...
    public void splitter(double divisor) {
        List<Number> updatedNumbers = new ArrayList<>(numbers.size());
        for (Number number : numbers) {
