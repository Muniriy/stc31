...
public class MainCalculator {
    ...
    /**
     * This method allows to make operations on array of
     * Numbers by calling several methods:
     * summation(), deleteInteger(), splitter(), toString(),
     * equals(), hashCode()
     */
    private static void runMathBoxTests() {
