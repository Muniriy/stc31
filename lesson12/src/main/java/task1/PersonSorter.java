...
public class PersonSorter {
    ...
    private static void sortPeople(Person[] people) {
        ...
        Sortable thirdPersonSorter = new ThirdPersonSorter();
        Person[] people2 = Arrays.copyOf(people, people.length);
        Person[] people3 = Arrays.copyOf(people, people.length);
        sorter(firstPersonSorter, people);
        sorter(secondPersonSorter, people2);
        sorter(thirdPersonSorter, people3);
    }
    ...
    private static void sorter(Sortable personSorter, Person[] people) {
        try {
            ...
            if (!Class.forName("task1.sorters.ThirdPersonSorter").equals(personSorter.getClass())) {
                personSorter.sortPeople(people);
            } else {
                people = personSorter.sortPeopleArray(people);
            }
        ...
        } catch (DuplicatedPersonException | ClassNotFoundException e) {
